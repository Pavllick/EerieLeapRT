...
ZTEST(system_configuration_controller, test_SystemConfigurationController_Save_config_successfully_saved) {
    ...
    auto system_configuration = std::make_shared<SystemConfiguration>();
    system_configuration->hw_version = 23456;
    system_configuration->sw_version = 87654;

    bool result = system_configuration_controller->Update(system_configuration);
    zassert_true(result);
...
ZTEST(system_configuration_controller, test_SystemConfigurationController_Save_config_and_Load) {
    ...
    auto system_configuration = std::make_shared<SystemConfiguration>();
    system_configuration->hw_version = 34567;
    system_configuration->sw_version = 98765;
