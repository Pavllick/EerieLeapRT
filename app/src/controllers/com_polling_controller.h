...
private:
    ...
    static int StartLoggingHandler(std::shared_ptr<LoggingController> logging_controller);
    static int StopLoggingHandler(std::shared_ptr<LoggingController> logging_controller);
