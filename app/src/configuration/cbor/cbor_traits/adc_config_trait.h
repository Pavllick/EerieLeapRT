...
#include "configuration/cbor/cbor_adc_config/adc_config_cbor_encode.h"
#include "configuration/cbor/cbor_adc_config/adc_config_cbor_decode.h"
#include "configuration/cbor/cbor_adc_config/adc_config_cbor_size.h"
