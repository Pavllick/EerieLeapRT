...
private:
    ext_unique_ptr<CborConfigurationService<LoggingConfig>> cbor_configuration_service_;
    ext_unique_ptr<ExtVector> config_raw_;
    ext_unique_ptr<LoggingConfig> config_;
...
public:
    explicit LoggingConfigurationManager(ext_unique_ptr<CborConfigurationService<LoggingConfig>> cbor_configuration_service);
