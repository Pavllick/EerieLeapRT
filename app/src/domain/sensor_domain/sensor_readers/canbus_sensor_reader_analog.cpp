...
#include "canbus_sensor_reader_analog.h"
...
CanbusSensorReaderAnalog::CanbusSensorReaderAnalog(
...
void CanbusSensorReaderAnalog::Read() {
    if(canbus_frame_.data.empty())
        return;
